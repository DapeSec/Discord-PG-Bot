...
async def _send_discord_message_async(channel_id, message_content):
    ...
    try:
        ...
        print(f"🔍 DEBUG: Peter attempting to send to channel {channel_id_int}")
...
async def on_message(message):
    ...
    if message.content.lower().startswith('!peter'):
        ...
        print(f"   🎯 Peter's mention string: {PETER_BOT_MENTION_STRING}")
    ...
    if not should_initiate_orchestration:
        ...
        print(f"   🎯 Peter mentioned: {client.user.mentioned_in(message)}")
