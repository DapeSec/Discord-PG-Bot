...
def get_character_info():
    ...
    return jsonify({
        ...
        "speech_patterns": [
            "Received Pronunciation British accent (upper-class)",
            "Sophisticated, adult vocabulary despite being infant",
            "Complex sentence structures and formal grammar",
            "Theatrical and dramatic delivery with poses",
            "Uses British colloquialisms and expressions",
            "Often speaks in monologues about evil plans",
            "Can switch to baby talk when manipulating or under stress",
            "Delivers cutting, witty observations about others"
        ],
